...
if __name__ == '__main__':
    '''print("----------tc_heap1.txt----------")
    parser = ParserHeap('C:\\Users\\ashva\\OneDrive\\Desktop\\Ashvath\\IITD\\SEM3\\COL106\\assignment3\\tc_heap1.txt')
    parser.parse()
    print()'''
    
    print("----------tc_treasury1.txt----------")
    parser = ParserTreasure('C:\\Users\\ashva\\OneDrive\\Desktop\\Ashvath\\IITD\\SEM3\\COL106\\assignment3\\tc_treasury1.txt')
    parser.parse()
    print()
    
    print("----------tc_treasury2.txt----------")
    parser = ParserTreasure('C:\\Users\\ashva\\OneDrive\\Desktop\\Ashvath\\IITD\\SEM3\\COL106\\assignment3\\tc_treasury2.txt')
    parser.parse()
    print()